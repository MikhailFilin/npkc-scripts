...
def export_instrumental_summary():
    ...
    try:
        ...
        SELECT
            ...
            diagnostic_ref.service_type,
            diagnostic_ref.anatomical_areas,
            ai_res.norma_value,
            ...
            SELECT t2.accession_number,
                sum(
                    CASE
                        ...
                        WHEN diagnostic_ref.service_type = 'КТ с КУ 1 зона' THEN 30.41
                        WHEN diagnostic_ref.service_type = 'КТ с КУ 2 и более зон' THEN 49.75
                        WHEN diagnostic_ref.service_type = 'КТ 1 зона' THEN 11.58
                        WHEN diagnostic_ref.service_type = 'КТ 2 и более зон' THEN 11.58
                        WHEN diagnostic_ref.service_type = 'МРТ 1 зона' THEN 15.06
                        WHEN diagnostic_ref.service_type = 'МРТ 2 и более зон' THEN 15.06
                        WHEN diagnostic_ref.service_type = 'МРТ с КУ 1 зона' THEN 34.71
                        WHEN diagnostic_ref.service_type = 'МРТ с КУ 2 и более зон' THEN 60.25
                        WHEN diagnostic_ref.service_type = 'ММГ' THEN 3.67
                        WHEN diagnostic_ref.service_type = 'РГ' THEN 3.67
                        WHEN diagnostic_ref.service_type = 'ФЛГ' THEN 1.0
                        WHEN diagnostic_ref.service_type = 'Денс' THEN 2.15
                        ELSE 1.0
                    END
        ...
        GROUP BY
            ...
            t2.assignment_describe_mu_id, diagnostic_ref.service_type,
            diagnostic_ref.anatomical_areas, ai_res.norma_value, ai_res_2.has_defect_ab,
...
def extract_phase():
    ...
    try:
        ...
        WITH diagnostic_dict AS (
            SELECT '1' AS diagnostic_code, 'РГ' AS service_type, 1 AS anatomical_areas
            UNION ALL SELECT '10', 'МРТ 1 зона', 1 UNION ALL SELECT '101', 'КТ с КУ 1 зона', 1
            UNION ALL SELECT '102', 'КТ 1 зона', 1 UNION ALL SELECT '103', 'КТ 2 и более зон', 2
            UNION ALL SELECT '104', 'КТ с КУ 2 и более зон', 2 UNION ALL SELECT '105', 'КТ 1 зона', 1
            UNION ALL SELECT '1058', 'КТ 1 зона', 1 UNION ALL SELECT '106', 'КТ 1 зона', 1
            UNION ALL SELECT '1060', 'КТ с КУ 1 зона', 1 UNION ALL SELECT '1061', 'КТ с КУ 1 зона', 1
            UNION ALL SELECT '1062', 'КТ с КУ 1 зона', 1 UNION ALL SELECT '1063', 'КТ с КУ 1 зона', 1
            UNION ALL SELECT '1065', 'КТ с КУ 2 и более зон', 2 UNION ALL SELECT '1066', 'КТ с КУ 2 и более зон', 2
            UNION ALL SELECT '1068', 'КТ с КУ 1 зона', 1 UNION ALL SELECT '1070', 'КТ с КУ 1 зона', 1
            UNION ALL SELECT '1073', 'КТ с КУ 1 зона', 1 UNION ALL SELECT '1075', 'КТ с КУ 1 зона', 1
            UNION ALL SELECT '1076', 'КТ с КУ 2 и более зон', 2 UNION ALL SELECT '1077', 'КТ с КУ 1 зона', 1
            UNION ALL SELECT '108', 'КТ 1 зона', 1 UNION ALL SELECT '11', 'МРТ с КУ 1 зона', 1
            UNION ALL SELECT '1106', 'КТ с КУ 1 зона', 1 UNION ALL SELECT '1107', 'МРТ 2 и более зон', 3
            UNION ALL SELECT '1108', 'МРТ с КУ 2 и более зон', 3 UNION ALL SELECT '1109', 'МРТ 2 и более зон', 2
            UNION ALL SELECT '1110', 'МРТ с КУ 2 и более зон', 2 UNION ALL SELECT '1111', 'МРТ 2 и более зон', 2
            UNION ALL SELECT '1113', 'МРТ 2 и более зон', 2 UNION ALL SELECT '1114', 'МРТ 2 и более зон', 2
            UNION ALL SELECT '1115', 'МРТ с КУ 2 и более зон', 2 UNION ALL SELECT '1116', 'МРТ 2 и более зон', 3
            UNION ALL SELECT '1117', 'МРТ с КУ 2 и более зон', 3 UNION ALL SELECT '1118', 'МРТ 2 и более зон', 3
            UNION ALL SELECT '1119', 'МРТ с КУ 2 и более зон', 3 UNION ALL SELECT '112', 'КТ 1 зона', 1
            UNION ALL SELECT '1120', 'МРТ 2 и более зон', 2 UNION ALL SELECT '1124', 'КТ с КУ 2 и более зон', 2
            UNION ALL SELECT '113', 'КТ с КУ 1 зона', 1 UNION ALL SELECT '1138', 'РГ', 2
            UNION ALL SELECT '1139', 'РГ', 2 UNION ALL SELECT '114', 'КТ 1 зона', 1
            UNION ALL SELECT '1140', 'РГ', 2 UNION ALL SELECT '1141', 'РГ', 2 UNION ALL SELECT '1142', 'РГ', 2
            UNION ALL SELECT '1143', 'РГ', 2 UNION ALL SELECT '1144', 'РГ', 2
            UNION ALL SELECT '115', 'КТ с КУ 1 зона', 1 UNION ALL SELECT '116', 'КТ 1 зона', 1
            UNION ALL SELECT '117', 'КТ с КУ 1 зона', 1 UNION ALL SELECT '118', 'КТ 2 и более зон', 2
            UNION ALL SELECT '121', 'КТ 1 зона', 1 UNION ALL SELECT '122', 'КТ 1 зона', 1
            UNION ALL SELECT '123', 'КТ 1 зона', 1 UNION ALL SELECT '124', 'КТ 1 зона', 1
            UNION ALL SELECT '125', 'КТ 1 зона', 1 UNION ALL SELECT '126', 'КТ 1 зона', 1
            UNION ALL SELECT '127', 'КТ 1 зона', 1 UNION ALL SELECT '128', 'КТ 2 и более зон', 2
            UNION ALL SELECT '129', 'КТ 1 зона', 1 UNION ALL SELECT '130', 'КТ 2 и более зон', 2
            UNION ALL SELECT '131', 'КТ 1 зона', 1 UNION ALL SELECT '132', 'КТ 1 зона', 1
            UNION ALL SELECT '133', 'КТ 1 зона', 1 UNION ALL SELECT '134', 'КТ 2 и более зон', 2
            UNION ALL SELECT '135', 'КТ с КУ 1 зона', 1 UNION ALL SELECT '137', 'КТ с КУ 1 зона', 1
            UNION ALL SELECT '138', 'КТ с КУ 2 и более зон', 2 UNION ALL SELECT '1381', 'МРТ 1 зона', 1
            UNION ALL SELECT '1382', 'РГ', 2 UNION ALL SELECT '1383', 'КТ с КУ 2 и более зон', 3
            UNION ALL SELECT '139', 'КТ с КУ 2 и более зон', 2 UNION ALL SELECT '1391', 'РГ', 1
            UNION ALL SELECT '140', 'КТ с КУ 1 зона', 1 UNION ALL SELECT '141', 'КТ с КУ 1 зона', 1
            UNION ALL SELECT '1412', 'РГ', 2 UNION ALL SELECT '143', 'МРТ 1 зона', 1
            UNION ALL SELECT '144', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '145', 'МРТ 1 зона', 1
            UNION ALL SELECT '146', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '147', 'МРТ 1 зона', 1
            UNION ALL SELECT '148', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '157', 'МРТ 1 зона', 1
            UNION ALL SELECT '159', 'МРТ 1 зона', 1 UNION ALL SELECT '160', 'МРТ с КУ 1 зона', 1
            UNION ALL SELECT '161', 'МРТ 1 зона', 1 UNION ALL SELECT '162', 'МРТ с КУ 1 зона', 1
            UNION ALL SELECT '163', 'МРТ 1 зона', 1 UNION ALL SELECT '166', 'МРТ 1 зона', 1
            UNION ALL SELECT '167', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '170', 'МРТ 1 зона', 1
            UNION ALL SELECT '171', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '172', 'МРТ 1 зона', 1
            UNION ALL SELECT '173', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '174', 'МРТ 1 зона', 1
            UNION ALL SELECT '175', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '179', 'МРТ 1 зона', 1
            UNION ALL SELECT '180', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '183', 'МРТ 1 зона', 1
            UNION ALL SELECT '184', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '185', 'МРТ 1 зона', 1
            UNION ALL SELECT '186', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '187', 'МРТ 1 зона', 1
            UNION ALL SELECT '188', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '189', 'МРТ 1 зона', 1
            UNION ALL SELECT '190', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '191', 'МРТ 1 зона', 1
            UNION ALL SELECT '192', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '193', 'МРТ 1 зона', 1
            UNION ALL SELECT '194', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '195', 'МРТ 1 зона', 1
            UNION ALL SELECT '197', 'МРТ 1 зона', 1 UNION ALL SELECT '198', 'МРТ с КУ 1 зона', 1
            UNION ALL SELECT '199', 'МРТ 1 зона', 1 UNION ALL SELECT '2', 'РГ', 1
            UNION ALL SELECT '200', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '201', 'МРТ 1 зона', 1
            UNION ALL SELECT '202', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '203', 'МРТ 1 зона', 1
            UNION ALL SELECT '204', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '205', 'МРТ 1 зона', 1
            UNION ALL SELECT '207', 'МРТ 1 зона', 1 UNION ALL SELECT '208', 'МРТ с КУ 1 зона', 1
            UNION ALL SELECT '209', 'МРТ 2 и более зон', 2 UNION ALL SELECT '211', 'МРТ 1 зона', 1
            UNION ALL SELECT '212', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '213', 'МРТ 1 зона', 1
            UNION ALL SELECT '227', 'МРТ 1 зона', 1 UNION ALL SELECT '3', 'РГ', 1
            UNION ALL SELECT '30', 'РГ', 1 UNION ALL SELECT '31', 'РГ', 1
            UNION ALL SELECT '32', 'РГ', 1 UNION ALL SELECT '33', 'РГ', 1
            UNION ALL SELECT '34', 'ФЛГ', 1 UNION ALL SELECT '35', 'РГ', 1
            UNION ALL SELECT '353', 'МРТ 1 зона', 1 UNION ALL SELECT '354', 'МРТ с КУ 1 зона', 1
            UNION ALL SELECT '355', 'МРТ 1 зона', 1 UNION ALL SELECT '356', 'МРТ с КУ 1 зона', 1
            UNION ALL SELECT '357', 'МРТ 1 зона', 1 UNION ALL SELECT '358', 'МРТ с КУ 1 зона', 1
            UNION ALL SELECT '359', 'МРТ 1 зона', 1 UNION ALL SELECT '36', 'РГ', 1
            UNION ALL SELECT '360', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '361', 'МРТ 1 зона', 1
            UNION ALL SELECT '362', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '364', 'МРТ 1 зона', 1
            UNION ALL SELECT '365', 'МРТ 1 зона', 1 UNION ALL SELECT '366', 'МРТ с КУ 1 зона', 1
            UNION ALL SELECT '367', 'МРТ 1 зона', 1 UNION ALL SELECT '368', 'МРТ с КУ 1 зона', 1
            UNION ALL SELECT '369', 'МРТ 1 зона', 1 UNION ALL SELECT '37', 'РГ', 1
            UNION ALL SELECT '370', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '372', 'МРТ 1 зона', 1
            UNION ALL SELECT '373', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '374', 'МРТ 1 зона', 1
            UNION ALL SELECT '375', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '376', 'МРТ 1 зона', 1
            UNION ALL SELECT '377', 'МРТ с КУ 1 зона', 1 UNION ALL SELECT '378', 'МРТ с КУ 1 зона', 1
            UNION ALL SELECT '384', 'КТ 1 зона', 1 UNION ALL SELECT '385', 'КТ 1 зона', 1
            UNION ALL SELECT '386', 'КТ 1 зона', 1 UNION ALL SELECT '387', 'КТ 1 зона', 1
            UNION ALL SELECT '388', 'КТ 1 зона', 1 UNION ALL SELECT '389', 'КТ 2 и более зон', 2
            UNION ALL SELECT '390', 'КТ 1 зона', 1 UNION ALL SELECT '391', 'КТ 2 и более зон', 3
            UNION ALL SELECT '392', 'КТ 2 и более зон', 2 UNION ALL SELECT '393', 'КТ 2 и более зон', 2
            UNION ALL SELECT '394', 'КТ 2 и более зон', 2 UNION ALL SELECT '395', 'КТ 2 и более зон', 4
            UNION ALL SELECT '396', 'КТ с КУ 1 зона', 1 UNION ALL SELECT '397', 'КТ с КУ 1 зона', 1
            UNION ALL SELECT '398', 'КТ с КУ 1 зона', 1 UNION ALL SELECT '4', 'РГ', 1
            UNION ALL SELECT '40', 'РГ', 1 UNION ALL SELECT '400', 'КТ с КУ 1 зона', 1
            UNION ALL SELECT '401', 'КТ с КУ 2 и более зон', 2 UNION ALL SELECT '404', 'КТ с КУ 2 и более зон', 3
            UNION ALL SELECT '407', 'КТ с КУ 1 зона', 1 UNION ALL SELECT '409', 'КТ с КУ 2 и более зон', 2
            UNION ALL SELECT '410', 'КТ с КУ 1 зона', 1 UNION ALL SELECT '411', 'КТ с КУ 2 и более зон', 3
            UNION ALL SELECT '412', 'КТ с КУ 2 и более зон', 2 UNION ALL SELECT '415', 'РГ', 1
            UNION ALL SELECT '417', 'РГ', 1 UNION ALL SELECT '418', 'РГ', 1 UNION ALL SELECT '419', 'РГ', 1
            UNION ALL SELECT '421', 'РГ', 1 UNION ALL SELECT '425', 'РГ', 1 UNION ALL SELECT '427', 'РГ', 1
            UNION ALL SELECT '428', 'РГ', 1 UNION ALL SELECT '43', 'РГ', 1 UNION ALL SELECT '430', 'РГ', 1
            UNION ALL SELECT '431', 'РГ', 1 UNION ALL SELECT '432', 'РГ', 1 UNION ALL SELECT '433', 'РГ', 1
            UNION ALL SELECT '44', 'РГ', 1 UNION ALL SELECT '448', 'РГ', 1 UNION ALL SELECT '449', 'РГ', 1
            UNION ALL SELECT '45', 'РГ', 1 UNION ALL SELECT '450', 'РГ', 1 UNION ALL SELECT '452', 'РГ', 1
            UNION ALL SELECT '453', 'РГ', 1 UNION ALL SELECT '454', 'РГ', 1 UNION ALL SELECT '459', 'РГ', 1
            UNION ALL SELECT '46', 'РГ', 1 UNION ALL SELECT '460', 'РГ', 1 UNION ALL SELECT '461', 'РГ', 1
            UNION ALL SELECT '462', 'РГ', 1 UNION ALL SELECT '463', 'РГ', 1 UNION ALL SELECT '464', 'РГ', 1
            UNION ALL SELECT '465', 'РГ', 1 UNION ALL SELECT '466', 'РГ', 1 UNION ALL SELECT '467', 'РГ', 1
            UNION ALL SELECT '468', 'РГ', 1 UNION ALL SELECT '469', 'РГ', 1
            UNION ALL SELECT '472', 'Денс', 1 UNION ALL SELECT '473', 'Денс', 1 UNION ALL SELECT '474', 'Денс', 1
            UNION ALL SELECT '475', 'МРТ с КУ 2 и более зон', 3 UNION ALL SELECT '476', 'МРТ 2 и более зон', 2
            UNION ALL SELECT '477', 'МРТ с КУ 2 и более зон', 2 UNION ALL SELECT '49', 'РГ', 1
            UNION ALL SELECT '5', 'КТ 1 зона', 1 UNION ALL SELECT '51', 'РГ', 1 UNION ALL SELECT '52', 'РГ', 1
            UNION ALL SELECT '523', 'ММГ', 1 UNION ALL SELECT '524', 'ММГ', 1
            UNION ALL SELECT '53', 'РГ', 1 UNION ALL SELECT '54', 'РГ', 1 UNION ALL SELECT '55', 'РГ', 1
            UNION ALL SELECT '56', 'РГ', 1 UNION ALL SELECT '57', 'РГ', 1 UNION ALL SELECT '58', 'РГ', 1
            UNION ALL SELECT '59', 'РГ', 1 UNION ALL SELECT '6', 'КТ 1 зона', 1
            UNION ALL SELECT '60', 'РГ', 1 UNION ALL SELECT '61', 'РГ', 1 UNION ALL SELECT '62', 'РГ', 1
            UNION ALL SELECT '63', 'РГ', 1 UNION ALL SELECT '64', 'РГ', 1 UNION ALL SELECT '65', 'РГ', 1
            UNION ALL SELECT '66', 'РГ', 1 UNION ALL SELECT '67', 'РГ', 1 UNION ALL SELECT '68', 'РГ', 1
            UNION ALL SELECT '69', 'РГ', 1 UNION ALL SELECT '7', 'КТ с КУ 1 зона', 1
            UNION ALL SELECT '70', 'РГ', 1 UNION ALL SELECT '72', 'РГ', 1 UNION ALL SELECT '73', 'РГ', 1
            UNION ALL SELECT '74', 'РГ', 1 UNION ALL SELECT '75', 'РГ', 1 UNION ALL SELECT '76', 'РГ', 1
            UNION ALL SELECT '77', 'РГ', 1 UNION ALL SELECT '79', 'Денс', 1
            UNION ALL SELECT '8', 'КТ 1 зона', 1 UNION ALL SELECT '80', 'ММГ', 1
            UNION ALL SELECT '83', 'ММГ', 1 UNION ALL SELECT '88', 'ММГ', 1
            UNION ALL SELECT '91', 'КТ 1 зона', 1 UNION ALL SELECT '92', 'КТ с КУ 1 зона', 1
            UNION ALL SELECT '921', 'Денс', 1 UNION ALL SELECT '93', 'КТ 1 зона', 1
            UNION ALL SELECT '94', 'КТ 1 зона', 1 UNION ALL SELECT '95', 'КТ с КУ 1 зона', 1
            UNION ALL SELECT '96', 'КТ с КУ 1 зона', 1 UNION ALL SELECT '97', 'КТ 1 зона', 1
            UNION ALL SELECT '98', 'КТ с КУ 1 зона', 1
        )
        SELECT
            toDate(toTimeZone(toDateTime(t2.assignment_result_doc_created_date), 'Europe/Moscow')) AS doc_date,
            ...
            diagnostic_ref.service_type, diagnostic_ref.anatomical_areas, ai_res.norma_value,
            sum(coeff.total_coefficient) AS total_coefficient,
            multiIf(ie.patient_age >= 18, 'Взрослые', ie.patient_age < 18 AND ie.patient_age IS NOT NULL, 'Дети', 'Не указано') AS age_group,
            multiIf(pin_res.max_task_pin_end_date IS NOT NULL, 1, 0) AS has_task_pin_record,
            multiIf(trauma_res.accession_number IS NOT NULL, 1, 0) AS trauma_after_orthopedist_flag,
            multiIf(
        ...
        GROUP BY doc_date, t2.assignment_result_emp_fio, t2.payment_source, t2.device_type,
            t2.diagnostic_name, t2.assessment_result_type_code, t2.conduct_mo_name,
            t2.conduct_mu_name, t2.conduct_district_name, t2.patient_gender,
            t2.assignment_describe_mu_id, diagnostic_ref.service_type,
            diagnostic_ref.anatomical_areas, ai_res.norma_value, ai_res_2.has_defect_ab,
